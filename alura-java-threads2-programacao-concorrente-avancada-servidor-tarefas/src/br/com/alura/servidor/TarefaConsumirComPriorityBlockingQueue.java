...
public class TarefaConsumirComPriorityBlockingQueue implements Runnable{
	
	private BlockingQueue<ComandoSimulaHTTP> filaComandos;
	
	public TarefaConsumirComPriorityBlockingQueue(BlockingQueue<ComandoSimulaHTTP> filaComandos) {
	...
	public void run() {
		...
		try {
			ComandoSimulaHTTP comando = null;
