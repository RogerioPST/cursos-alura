...
/*
 * A quantidade de threads cresce à medida que a demanda aumenta. O legal é que o pool também 
 ...
 */
	...
	while(true) {	
/*
 * O método accept é bloqueante e trava a thread principal. Ou seja, ao rodar, a thread main 
 * fica parada até receber uma conexão através de um cliente. Repare também que o retorno 
 * desse método é um Socket, que abstrai os detalhes da conexão.
 */
 ...
 * assim tb.
 * 
 * Os clientes fazem a conexão através da porta 12347, já que esta é a porta para a 
 * comunicação com o nosso servidor. Após isto, a comunicação do servidor para o 
 * cliente é feita através de uma porta especifica para cada cliente.		
 */
		System.out.println("aceitando novo cliente na porta: " + socket.getPort());
		
		DistribuirTarefasInicial distribuir = new DistribuirTarefasInicial(socket);
/*
 * É um gerenciador de objetos do tipo thread, que é capaz de limitar a quantidade de threads 
 * além de fazer um reaproveitamento das mesmas,não tendo o gasto de CPU de criar uma nova 
...
//System.out.println("fim do sleep - usado p teste antes de ter a thread distribuirTarefas");
	...
	//ambos os codigos abaixo n serao alcançados, pq estamos c laço while(true). p resolver esse 
