...
public class PopulaMovimentacao {
	...
	public static void main(String[] args) {
		...
		ContaJPA ContaJPA1 = manager.find(ContaJPA.class,1);
		ContaJPA ContaJPA2 = manager.find(ContaJPA.class,2);
		ContaJPA ContaJPA3 = manager.find(ContaJPA.class,3);
		ContaJPA ContaJPA4 = manager.find(ContaJPA.class,4);
		ContaJPA ContaJPA5 = manager.find(ContaJPA.class,5);


		// Movimentacoes da ContaJPA1
		...
		movimentacao2.setContaJPA(ContaJPA1);
		...
		movimentacao3.setContaJPA(ContaJPA1);
		...
		movimentacao4.setContaJPA(ContaJPA1);

		manager.persist(movimentacao4);

		// Movimentacoes da ContaJPA2
		...
		movimentacao6.setContaJPA(ContaJPA2);

		manager.persist(movimentacao6);

		// Movimentacoes da ContaJPA3
		...
		movimentacao7.setContaJPA(ContaJPA3);
		...
		movimentacao8.setContaJPA(ContaJPA3);
		...
		movimentacao9.setContaJPA(ContaJPA3);

		manager.persist(movimentacao9);

		// Movimentacoes da ContaJPA4
		...
		movimentacao10.setContaJPA(ContaJPA4);

		manager.persist(movimentacao10);

		// Movimentacoes da ContaJPA5
		...
		movimentacao11.setContaJPA(ContaJPA5);
		...
		movimentacao12.setContaJPA(ContaJPA5);
